...
clear; clc; close all
swept_data = 'coefficient_swept.dat';

raw = importdata(swept_data);
...
figure('Name','Convergence Proof | Swept','Color','w','Position',[100 100 800 700]);
...
sgtitle('Convergence Proof | Swept','Color', 'k');