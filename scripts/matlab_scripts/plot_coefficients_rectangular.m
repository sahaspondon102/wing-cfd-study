...
clear; clc; close all
rect_data = 'coefficient_rect.dat';

raw = importdata(rect_data);
...
figure('Name','Convergence Proof | Rect','Color','w','Position',[100 100 800 700]);
...
sgtitle('Convergence Proof | Rectangular','Color', 'k');